...
| overview                 | text null        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| created_at               | timestamptz      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| updated_at               | timestamptz      | `not null default now()`. "Last activity" the client portal shows as the milestone's "Updated" time. Bumped **only on client-visible changes**: to the milestone's own `name`/`status`/`overview`/`start_date`/`expected_completion_date`, or when a `timeline_update` is added/removed or has its `title`/`status`/`entry_date`/`description`/`required_action` changed. Internal-only edits (`weight`, `scope_finalized`, `position`, the `progress` cache) do **not** bump it. Enforced by column-scoped `WHEN` triggers (`milestones_set_updated_at`, `timeline_updates_touch_milestone_ins/del/upd`).                                                                                                                                                                                                                                                                        |
